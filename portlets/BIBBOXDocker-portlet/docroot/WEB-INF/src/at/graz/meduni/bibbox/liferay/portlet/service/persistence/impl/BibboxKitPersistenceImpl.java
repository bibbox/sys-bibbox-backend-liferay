...
public class BibboxKitPersistenceImpl extends BasePersistenceImpl<BibboxKit>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_KITNAME = new FinderPath(BibboxKitModelImpl.ENTITY_CACHE_ENABLED,
			BibboxKitModelImpl.FINDER_CACHE_ENABLED, BibboxKitImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByKitName",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_KITNAME =
		new FinderPath(BibboxKitModelImpl.ENTITY_CACHE_ENABLED,
			BibboxKitModelImpl.FINDER_CACHE_ENABLED, BibboxKitImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByKitName",
	 ...
	 */
	@Override
	public List<BibboxKit> findByKitName(String kitName) {
		return findByKitName(kitName, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<BibboxKit> findByKitName(String kitName, int start, int end) {
		return findByKitName(kitName, start, end, null);
	}
	...
	public List<BibboxKit> findByKitName(String kitName, int start, int end,
		OrderByComparator<BibboxKit> orderByComparator) {
		return findByKitName(kitName, start, end, orderByComparator, true);
	}
	...
	public List<BibboxKit> findByKitName(String kitName, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_KITNAME;
			finderArgs = new Object[] { kitName };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_KITNAME;
	 ...
	 */
	@Override
	public BibboxKit findByKitName_First(String kitName,
		OrderByComparator<BibboxKit> orderByComparator)
		throws NoSuchBibboxKitException {
		BibboxKit bibboxKit = fetchByKitName_First(kitName, orderByComparator);
	 ...
	 */
	@Override
	public BibboxKit fetchByKitName_First(String kitName,
		OrderByComparator<BibboxKit> orderByComparator) {
		List<BibboxKit> list = findByKitName(kitName, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public BibboxKit findByKitName_Last(String kitName,
		OrderByComparator<BibboxKit> orderByComparator)
		throws NoSuchBibboxKitException {
		BibboxKit bibboxKit = fetchByKitName_Last(kitName, orderByComparator);
	 ...
	 */
	@Override
	public BibboxKit fetchByKitName_Last(String kitName,
		OrderByComparator<BibboxKit> orderByComparator) {
		int count = countByKitName(kitName);

		if (count == 0) {
			return null;
		}

		List<BibboxKit> list = findByKitName(kitName, count - 1, count,
				orderByComparator);
	...
	public BibboxKit[] findByKitName_PrevAndNext(long bibboxKitId,
		...
		try {
			...
			array[0] = getByKitName_PrevAndNext(session, bibboxKit, kitName,
					orderByComparator, true);

			array[1] = bibboxKit;

			array[2] = getByKitName_PrevAndNext(session, bibboxKit, kitName,
	...
	protected BibboxKit getByKitName_PrevAndNext(Session session,
	 ...
	 */
	@Override
	public void removeByKitName(String kitName) {
		for (BibboxKit bibboxKit : findByKitName(kitName, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public int countByKitName(String kitName) {
	...
	public BibboxKit updateImpl(BibboxKit bibboxKit) {
		...
		if (isNew || !BibboxKitModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((bibboxKitModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_KITNAME.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						bibboxKitModelImpl.getOriginalKitName()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_KITNAME, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_KITNAME,
					args);
