...
public class ApplicationStoreItemServiceSoap {
	public static java.lang.String getApplicationStoreListAPI()
		...
		try {
			com.liferay.portal.kernel.json.JSONObject returnValue = ApplicationStoreItemServiceUtil.getApplicationStoreListAPI();
	...
	public static java.lang.String getApplicationStoreUpdatedListAPI()
		throws RemoteException {
		try {
			com.liferay.portal.kernel.json.JSONObject returnValue = ApplicationStoreItemServiceUtil.getApplicationStoreUpdatedListAPI();
