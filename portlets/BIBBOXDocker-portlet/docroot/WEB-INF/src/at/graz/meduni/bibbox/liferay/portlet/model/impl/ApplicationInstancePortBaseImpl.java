...
/**
 * The extended model base implementation for the ApplicationInstancePort service. Represents a row in the &quot;bibboxdocker_ApplicationInstancePort&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This class exists only as a container for the default extended model level methods generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ApplicationInstancePortImpl}.
 * </p>
 *
 * @author Robert Reihs
 ...
 */
@ProviderType
public abstract class ApplicationInstancePortBaseImpl
	extends ApplicationInstancePortModelImpl implements ApplicationInstancePort {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
