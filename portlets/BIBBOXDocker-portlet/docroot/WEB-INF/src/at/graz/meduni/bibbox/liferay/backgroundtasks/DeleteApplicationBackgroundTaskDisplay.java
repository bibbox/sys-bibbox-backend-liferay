...
public class DeleteApplicationBackgroundTaskDisplay  extends BaseBackgroundTaskDisplay {
	...
	public DeleteApplicationBackgroundTaskDisplay(BackgroundTask backgroundTask) {
