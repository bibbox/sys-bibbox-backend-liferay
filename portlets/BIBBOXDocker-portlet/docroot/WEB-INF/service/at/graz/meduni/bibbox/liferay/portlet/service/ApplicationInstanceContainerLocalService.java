...
/**
 * Provides the local service interface for ApplicationInstanceContainer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Robert Reihs
 * @see ApplicationInstanceContainerLocalServiceUtil
...
public interface ApplicationInstanceContainerLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApplicationInstanceContainerLocalServiceUtil} to access the application instance container local service. Add custom service methods to {@link at.graz.meduni.bibbox.liferay.portlet.service.impl.ApplicationInstanceContainerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ApplicationInstanceContainer addApplicationInstanceContainer(
	...
	*/
	public ApplicationInstanceContainer createApplicationInstanceContainer(
	...
	*/
	...
	public ApplicationInstanceContainer deleteApplicationInstanceContainer(
		ApplicationInstanceContainer applicationInstanceContainer);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ApplicationInstanceContainer deleteApplicationInstanceContainer(
		long applicationInstanceContainerId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationInstanceContainer fetchApplicationInstanceContainer(
		long applicationInstanceContainerId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationInstanceContainer getApplicationInstanceContainer(
		long applicationInstanceContainerId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ApplicationInstanceContainer updateApplicationInstanceContainer(
		ApplicationInstanceContainer applicationInstanceContainer);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ApplicationInstanceContainer> getApplicationInstanceContainerForInstance(
		long applicationinstanceId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ApplicationInstanceContainer> getApplicationInstanceContainerNeedToRun(
		long applicationinstanceId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ApplicationInstanceContainer> getApplicationInstanceContainers(
		int start, int end);
