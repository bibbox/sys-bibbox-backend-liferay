...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"BIBBOXDocker-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "BIBBOXDocker-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(ApplicationInstanceClp.class.getName())) {
	...
	public static Object translateInputApplicationInstance(
		BaseModel<?> oldModel) {
	...
	public static Object translateInputApplicationInstancePort(
		BaseModel<?> oldModel) {
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"at.graz.meduni.bibbox.liferay.portlet.model.impl.ApplicationInstancePortImpl")) {
			return translateOutputApplicationInstancePort(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"at.graz.meduni.bibbox.liferay.portlet.exception.NoSuchApplicationInstanceException")) {
			return new at.graz.meduni.bibbox.liferay.portlet.exception.NoSuchApplicationInstanceException(throwable.getMessage(),
				throwable.getCause());
		}
	...
	public static Object translateOutputApplicationInstance(
		BaseModel<?> oldModel) {
		ApplicationInstanceClp newModel = new ApplicationInstanceClp();
	...
	public static Object translateOutputApplicationInstancePort(
		BaseModel<?> oldModel) {
		ApplicationInstancePortClp newModel = new ApplicationInstancePortClp();
