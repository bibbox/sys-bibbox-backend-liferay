...
/**
 * Provides the local service interface for ApplicationTag. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Robert Reihs
 * @see ApplicationTagLocalServiceUtil
...
public interface ApplicationTagLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApplicationTagLocalServiceUtil} to access the application tag local service. Add custom service methods to {@link at.graz.meduni.bibbox.liferay.portlet.service.impl.ApplicationTagLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ApplicationTag addApplicationTag(ApplicationTag applicationTag);
	...
	*/
	public ApplicationTag createApplicationTag(long applicationTagsId);
	...
	*/
	...
	public ApplicationTag deleteApplicationTag(ApplicationTag applicationTag);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ApplicationTag deleteApplicationTag(long applicationTagsId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationTag fetchApplicationTag(long applicationTagsId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ApplicationTag getApplicationTag(long applicationTagsId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ApplicationTag updateApplicationTag(ApplicationTag applicationTag);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ApplicationTag> getApplicationTags(int start, int end);
