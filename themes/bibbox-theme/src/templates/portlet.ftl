...
<section class="portlet" id="portlet_${portlet_id}">
	...
	<div class="${portlet_content_css_class}">
		...
		<#if portlet_display.getPortletDecoratorId() != "barebone" && portlet_display.getPortletDecoratorId() != "two-column" && portlet_display.getPortletDecoratorId() != "formatted-columns" && portlet_display.getPortletDecoratorId() != "formatted">
